...
<div id="order_review">
	...
	<div id="payment">
		...
		<div class="toggles-container accordion-container check-listing payments-listing">
			<?php
			...
			if ( ! empty( $available_gateways ) ) {
				...
				?>
				<div class="toggle-container <?php if($gateway->chosen) { ?>expanded<?php } ?>">
					<div class="toggle-title clearfix">
						<input type="radio" id="payment_method_<?php echo $gateway->id; ?>" class="hidden" name="payment_method" value="<?php echo esc_attr( $gateway->id ); ?>" <?php checked( $gateway->chosen, true ); ?> />
						<h5 class="nomargin"><?php echo $gateway->get_title(); ?></h5>
					</div>
