...
class ThemexShortcode {
	...
	public static function initScripts() {
		...
		$out.='themexTitle="'.__('Insert Shortcode', 'lovestory').'";';
	...
	public static function renderSettings() {
		...
		if(isset(self::$data['clone'])) {
			...
			$out.='<a href="#" class="themex-button themex-remove-button themex-trigger" data-element="'.$ID.'" title="'.__('Remove', 'lovestory').'"></a>';
			$out.='<a href="#" class="themex-button themex-clone-button themex-trigger" data-element="'.$ID.'" data-value="'.$ID.'" title="'.__('Add', 'lovestory').'"></a>';
		...
		$out.='<tr><th></th><td><div class="themex-option themex-submit"><input type="submit" class="themex-button" value="'.__('Insert Shortcode','lovestory').'" /></div></td></tr>';
		$out.='</tbody></table>';
